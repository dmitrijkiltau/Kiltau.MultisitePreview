...
module.exports = {"secondaryToolbar__buttonLink":"MultisitePreview__secondaryToolbar__buttonLink___1xAH_","secondaryToolbar__buttonLink--isDisabled":"MultisitePreview__secondaryToolbar__buttonLink--isDisabled___1KvmJ","secondaryToolbar__dropDown":"MultisitePreview__secondaryToolbar__dropDown___1s2zP"};

/***/ }),

/***/ "./src/MultisitePreview.js":
/*!******************************!*\
  !*** ./src/MultisitePreview.js ***!
  \******************************/
/*! no static exports found */
...
var _MultisitePreview = __webpack_require__(/*! ./MultisitePreview.css */ "./src/MultisitePreview.css");

var _MultisitePreview2 = _interopRequireDefault(_MultisitePreview);
...
var MultisitePreview = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
				return {
...
}), _dec(_class = _dec2(_class = (_temp2 = _class2 = class MultisitePreview extends _react.PureComponent {
				constructor() {
								var _temp, _this;
				...
				componentDidMount() {
								...
								return _asyncToGenerator(function* () {
												...
												var siteIdentifiers = currentContextNode.properties.baseSite;
				...
				render() {
								...
								var previewButtonClassNames = (0, _classnames2.default)((_mergeClassNames = {}, _defineProperty(_mergeClassNames, _MultisitePreview2.default.secondaryToolbar__buttonLink, true), _defineProperty(_mergeClassNames, _MultisitePreview2.default['secondaryToolbar__buttonLink--isDisabled'], !previewUrl), _mergeClassNames));
								...
								if (preview.length > 1) {
												return _react2.default.createElement(
																...
																_react2.default.createElement(
																				'ul',
																				{
																								className: _MultisitePreview2.default.secondaryToolbar__dropDown,
																								...
																								return _react2.default.createElement(
																												...
																												_react2.default.createElement(
																																'a',
																																{
																																				...
																																				href: site.uri,
																																				target: 'neosPreview',
																																				className: _MultisitePreview2.default.secondaryToolbar__buttonLink,
...
exports.default = MultisitePreview;
...
var _MultisitePreview = __webpack_require__(/*! ./MultisitePreview */ "./src/MultisitePreview.js");

var _MultisitePreview2 = _interopRequireDefault(_MultisitePreview);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('Kiltau.MultisitePreview:MultisitePreview', {}, function (globalRegistry) {
  var containerRegistry = globalRegistry.get('containers');
  //console.log('MultisitePreview', MultisitePreview);
  containerRegistry.set('SecondaryToolbar/Right/PreviewButton', _MultisitePreview2.default);
